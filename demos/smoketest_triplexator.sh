...
then
	PASSED=`expr ${PASSED} + 1`
	echo "Test: relaxed 50% guanine rate settings TFO........OK"
else
	FAILED=`expr ${FAILED} + 1`
	echo "Test: relaxed 50% guanine rate settings TFO........FAILED"
fi
...
$TRIPLEXATOR --duplicate-locations --detect-duplicates 1 --duplicate-cutoff 2 -o test_duplicates_filtering_permissive.tfo -od ${DEMOS}/tests -of 0 --pretty-output -ss ${DEMOS}/single-stranded.fasta 
...
$TRIPLEXATOR --duplicate-locations --detect-duplicates 2 --duplicate-cutoff 2 -o test_duplicates_filtering_strict.tfo -od ${DEMOS}/tests -of 0 --pretty-output -ss ${DEMOS}/single-stranded.fasta 
...
$TRIPLEXATOR --detect-duplicates 1 --duplicate-cutoff 0 -o test_duplicates_filtering.tts -od ${DEMOS}/tests -of 0 --pretty-output -ds ${DEMOS}/double-stranded.fasta
